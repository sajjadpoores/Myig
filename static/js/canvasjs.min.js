        ...
        if (!db) {
            ...
            if (m.creditHref && m.creditText) {
                m._creditLink || (m._creditLink = document.createElement("a"), m._creditLink.setAttribute("class", "canvasjs-chart-credit"), m._creditLink.setAttribute("title", "JavaScript Charts"), m._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" +
                    (m.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: vazir,Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"), m._creditLink.setAttribute("tabIndex", -1), m._creditLink.setAttribute("target", "_blank"));
    ...
    var W = {},
        ...
        qa = {
            ...
            CultureInfo: {
                ...
                saveJPGText: "ذخیره با فرمت JPEG",
                savePNGText: "ذخیره با فرمت PNG",
                printText: "پرینت نمودار",
    ...
    Ka.Chart = function () {
        ...
        q.prototype._updateOptions = function () {
            ...
            if (!this._dropdownMenu && this.exportEnabled && v) {
                ...
                this._dropdownMenu.style.cssText = "position: absolute; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 150px;outline: 0;font-size: 14px; font-family: vazir,Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;direction: rtl;text-align: left;line-height: 10px;background-color:" + this.toolbar.backgroundColor + ";box-shadow: 2px 2px 10px " +
                    b;
        ...
        Z.prototype._initialize = function () {
            if (this.enabled) {
                ...
                a += "padding: 5px;";
                a += "font-family: vazir,Calibri, Arial, Georgia, serif;";
